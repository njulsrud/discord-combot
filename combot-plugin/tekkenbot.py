...
async def on_ready():
    ...
    while True:
        ...
        await asyncio.sleep(30)
        await bot.change_presence(game=discord.Game(name='Casuals: GamerHeadz.  Every South Dale Monday 4:30 to 8:30'))
        await asyncio.sleep(30)
        await bot.change_presence(game=discord.Game(name='ProTip: Keo is free'))
        await asyncio.sleep(30)
        await bot.change_presence(game=discord.Game(name='ProTip: Noctis doesn''t belong in Tekken'))
        await asyncio.sleep(30)
